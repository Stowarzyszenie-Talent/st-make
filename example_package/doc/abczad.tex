...
% \tCustomSection{text} % Nagłówek w stylu talentu, z możliwością ustawienia odstępu od poprzedniego akapitu.
...
\makestandardexample{a}  % testy muszą być wygenerowane więc użyj st-make ingen outgen
