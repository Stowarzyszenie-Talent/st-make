...
\Memory{256} % HINT: Nie dodawać "MB"
% HINT: Pola konkurs, etap, day, date uzupełnia kierownik konkursu.
\konkurs{SKN 2022/23}
\day{Dzień 1}
...
% \tNoSkipSection{text} % Jak wyżej, tylko bez odstęp między akapitami
